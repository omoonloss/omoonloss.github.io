...
export default {
  // fetch_test_site () {
  //   return JSON.parse(window.localStorage.getItem('design') || '[]')
  // },
  // save_test_site (items) {
  //   window.localStorage.setItem('design', JSON.stringify(items))
  // },
  fetch_site () {
